...
class ViewSlot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const viewproductcartnew(title: ''),
    );
  }
  
}

class viewproductcartnew extends StatefulWidget {
  const viewproductcartnew({super.key, required this.title});

  final String title;

  @override
  State<viewproductcartnew> createState() => _viewproductcartnewState();
}

class _viewproductcartnewState extends State<viewproductcartnew> {

  _viewproductcartnewState(){
    ViewSlot();
  }
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    final urls = Uri.parse('$url/myapp/cartpayment/');
    try {
  ...
  Future<void> ViewSlot() async {
    ...
    try {
      ...
      for (int i = 0; i < arr.length; i++) {
        ...
        name.add(arr[i]['product'].toString());
